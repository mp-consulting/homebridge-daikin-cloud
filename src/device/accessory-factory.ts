...
import type { PlatformAccessory, Logger } from 'homebridge';
import type { DaikinCloudAccessoryContext, DaikinCloudPlatform } from '../platform';
import type { DeviceProfile } from './profiles/device-profile';
import { DeviceType, matchDeviceProfile } from './profiles/device-profile';
import type { BaseAccessory } from '../accessories';
import { AirConditioningAccessory, AlthermaAccessory } from '../accessories';
